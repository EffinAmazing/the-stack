...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppModulesBlueprintComponentsBuilderBuilderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function BuilderComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("cdkDragReleased", function BuilderComponent_div_7_Template_div_cdkDragReleased_0_listener($event) {
          ...
          return ctx_r18.relisedMove($event, node_r17);
          ...
          return ctx_r20.handleNodeMove($event, node_r17);
          ...
          return ctx_r21.handleStartDrag(node_r17);
          ...
          return ctx_r22.handleMouseOverNode($event, node_r17);
          ...
          return ctx_r23.handleMouseOutNode($event, node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_3_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r19);
          ...
          return ctx_r24.handleAddArrowClick($event, "Left", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_4_listener($event) {
          ...
          return ctx_r25.handleAddArrowClick($event, "Right", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_5_listener($event) {
          ...
          return ctx_r26.handleAddArrowClick($event, "LeftTop", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_6_listener($event) {
          ...
          return ctx_r27.handleAddArrowClick($event, "RightTop", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_7_listener($event) {
          ...
          return ctx_r28.handleAddArrowClick($event, "MiddleTop", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_8_listener($event) {
          ...
          return ctx_r29.handleAddArrowClick($event, "LeftBottom", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_9_listener($event) {
          ...
          return ctx_r30.handleAddArrowClick($event, "RightBottom", node_r17);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BuilderComponent_div_7_Template_div_click_10_listener($event) {
          ...
          return ctx_r31.handleAddArrowClick($event, "MiddleBottom", node_r17);
        });
          ...
          if (this.connectedLines.length) {
            ...
            this.connectedLines.forEach(function (item) {
              ...
              if (item.start.nodeId === node.id) {
                ...
                _this2.svgD3.select('path#' + item.lineId).attr('d', lineGenerator(_this2.genrateDots([item.start.x, item.start.y], [item.end.x, item.end.y])));
              }
              ...
              if (item.end.nodeId === node.id) {
                ...
                _this2.svgD3.select('path#' + item.lineId).attr('d', lineGenerator(_this2.genrateDots([item.start.x, item.start.y], [item.end.x, item.end.y], item.end.pos !== 'Left' || item.end.pos !== 'Right' ? 'Top' : '')));
              }
            });
          }
        }
    ...
    BuilderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_4__["CdkDrag"]],
  ...
  function srcAppModulesBlueprintPagesBuildStackBuildStackComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function BuildStackComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BuildStackComponent_div_5_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);

          var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r6.handleHideList();
        });
    ...
    function BuildStackComponent_app_builder_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("positionNodeChanged", function BuildStackComponent_app_builder_8_Template_app_builder_positionNodeChanged_0_listener($event) {
          ...
          return ctx_r10.updatedNodePosiotion($event);
        });
    ...
    function BuildStackComponent_div_16_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function BuildStackComponent_div_16_Template_mat_slide_toggle_change_13_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);

          var nodeId_r12 = ctx.$implicit;

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r13.handleHideNodeItem(ctx_r13.nodes[nodeId_r12]);
        });
      ...
      _createClass(BuildStackComponent, [{
          ...
          if (this.domain) {
            this.service.getDomainTools(this.domain).subscribe(function (data) {
              ...
              data.nodes.forEach(function (item) {
                ...
                item.tool = tool;
                _this4.nodes[item.id] = item;

                _this4.nodesList.push(item.id);
                ...
                if (item.tool.categories) {
                  item.tool.categories.forEach(function (cat) {
                    if (_this4.categories[cat]) {
                      _this4.categories[cat].push(item.id);
                    } else {
                      _this4.categories[cat] = [item.id];
                    }
                  });
                } else {
                  _this4.categories['None'].push(item.id);
                }
                /*if (!item.hide) {
              ...
              if (data.nodes.length - hidden > 50) {
                _this4.proceedNodes(data.nodes.length, hidden);
              } else {
                _this4.completedProceedNodes();
              } // console.log(this.nodes, this.nodes.length);

            }, function (err) {
              return _this4.isError = true;
            });
          } else {
            this.isError = true;
          }
        ...
        value: function proceedNodes(all, hidden, force) {
          ...
          if (force) {
            this.nodesList.forEach(function (nodeId) {
              var item = _this5.nodes[nodeId];

              if (!item.hide && all - hidden > 50) {
                if (item.tool.categories[0].search('Analytics') === -1 && item.tool.name !== _this5.domain) {
                  item.hide = true;
                  hidden++;

                  _this5.nodesForUpdate.push(item.id);
                }
              }
            });
        ...
        value: function updatedNodePosiotion(data) {
          ...
          this.service.updateNodeTool(data.nodeId, {
            ...
            var tool = _this6.nodes[data.nodeId].tool;
            res.tool = _this6.nodes[data.nodeId].tool;
            _this6.nodes[data.nodeId] = res;
          });
        }
      }, {
        ...
        value: function completedProceedNodes() {
          ...
          if (this.nodesForUpdate.length) {
            this.service.hideNodes(this.nodesForUpdate).subscribe(function (data) {
              _this7.changedNodes$.next({
                nodes: _this7.nodes,
                list: _this7.nodesList
              });
            });
          } else {
        ...
        value: function handleHideNodeItem(data) {
          ...
          this.service.updateNodeTool(data.id, {
            ...
            res.tool = _this8.nodes[data.id].tool;
            _this8.nodes[data.id] = res;

            _this8.changedNodes$.next({
              nodes: _this8.nodes,
              list: _this8.nodesList
            }); // this.margeShowNodes();
    ...
    BuildStackComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 17,
      vars: 8,
      consts: [[1, "main"], [1, "mt-container"], [1, "stackContainer"], ["class", "stackActions", 4, "ngIf"], ["class", "loading-data-section", 4, "ngIf"], ["class", "error-loading-alert", 4, "ngIf"], [3, "loadedNodes", "positionNodeChanged", 4, "ngIf"], [3, "ngClass"], [1, "header-tools"], [1, "title"], ["mat-icon-button", "", 3, "click"], [1, "tools-node-items"], ["class", "node-item", 4, "ngFor", "ngForOf"], [1, "stackActions"], ["mat-raised-button", "", 3, "click"], [1, "loading-data-section"], [1, "loading-message"], [1, "error-loading-alert"], ["color", "accent"], [1, "error-message"], ["mat-button", "", "color", "primary", 3, "click"], [3, "loadedNodes", "positionNodeChanged"], [1, "node-item"], [1, "item-categories"], [1, "item-name"], [1, "item-description"], [1, "actions"], [1, "example-margin", 3, "checked", "color", "change"]],
      template: function BuildStackComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BuildStackComponent_Template_button_click_12_listener() {
  ...
  function srcAppSharedModulesMaterialLayoutLayoutModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LayoutModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_material_card__WEBPACK_IMPORTED_MODULE_1__["MatCardModule"]], _angular_material_card__WEBPACK_IMPORTED_MODULE_1__["MatCardModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LayoutModule, {
        imports: [_angular_material_card__WEBPACK_IMPORTED_MODULE_1__["MatCardModule"]],
        exports: [_angular_material_card__WEBPACK_IMPORTED_MODULE_1__["MatCardModule"]]
      });
    })();
    /*@__PURE__*/
